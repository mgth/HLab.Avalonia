...
public class TextBoxEx : TextBox, IDoubleProvider
{
    ...
    public static readonly StyledProperty<TextBoxMode> ModeProperty = H
        .Property<TextBoxMode>()
        .Default(TextBoxMode.Text)
        .OnChanged((e, a) => e.OnModeChanged(a.NewValue.Value))
        .Register();
    ...
    public static readonly StyledProperty<DisplayZeros> DisplayZerosProperty =
    ...
    public DisplayZeros DisplayZeros
    {
        ...
        get => GetValue(DisplayZerosProperty);
    }
    ...
    public static readonly StyledProperty<DateTime> DateProperty =
        H.Property<DateTime>()
            ...
            .OnChanged((e, a) => e.OnDateChanged(a.NewValue.Value))
            .Register();
    ...
    public static readonly RoutedEvent DateChangeEvent = H.Event<RoutedEventArgs>().Bubble.Register();

    public event EventHandler<RoutedEventArgs> DateChange
    {
    ...
    public static readonly StyledProperty<double> DoubleProperty =
        H.Property<double>()
            .Default(0.0)
            .OnChanged((e, a) => e.OnDoubleChanged(a.NewValue.Value))
            .BindModeDefault()
            .Register();
    ...
    public static readonly RoutedEvent DoubleChangeEvent = H.Event<RoutedEventArgs>().Bubble.Register();

    public event EventHandler<RoutedEventArgs> DoubleChange
    {
    ...
    public static readonly StyledProperty<bool> IsValidProperty = H.Property<bool>().Default(true).Register();
    ...
    public static readonly RoutedEvent IsValidChangedEvent = H.Event<RoutedEventArgs>().Bubble.Register();

    public event EventHandler<RoutedEventArgs> IsValidChanged
    {
    ...
    public static readonly StyledProperty<bool> EnlightenedProperty = H.Property<bool>().Default(false).Register();
    //DependencyProperty.RegisterAttached("Eclaire", typeof(bool), typeof(TextBoxEx), new UIPropertyMetadata(false));

    public static bool GetEnlightened(AvaloniaObject d)
    {
        return (bool)d.GetValue(EnlightenedProperty);
    }

    public static void SetEnlightened(AvaloniaObject d, bool value)
    {
